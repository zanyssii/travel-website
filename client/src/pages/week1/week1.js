...
// Images
const workoutImg = "./assets/images/travel1.jpg";
const waterImg = "./assets/images/thing1.jpg";
const sleepImg = "./assets/images/flight1.jpg";
const nutritionImg = "./assets/images/tips1.jpg";
